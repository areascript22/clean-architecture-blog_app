...
class BlogRepositoryImpl implements BLogRepository {
  ...
  Future<Either<Failure, Blog>> uploadBlog({
    ...
    try {
      ...
      final imageString = await remoteDataSource.uploadBlogImage(
        image: image,
        blog: blog,
      );
      blog = blog.copyWith(imageUrl: imageString);

      final uploadedBlog = await remoteDataSource.uploadBlog(blog);
